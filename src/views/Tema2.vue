...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
        ...
        .row.justify-content-center.mb-5(data-aos="flip-up")
          .col-lg-8
            LineaTiempoD.linea-tiempo-d.mb-5
              p(numero="1" titulo="&lt;!DOCTYPE&gt;") Se utiliza, inicialmente, para indicar qué tipo de documento es el que tiene que interpretarse o crearse, en este caso HTML. 
                img.img-a.mt-4(src='@/assets/curso/tema_2/img_3.png', alt='Texto que describa la imagen')
              
              p(numero="2" titulo="&lt;html&gt;") Esta es la etiqueta principal de la estructura de un documento HTML, esta etiqueta encapsula todo el contenido del documento.
                img.img-a.mt-4(src='@/assets/curso/tema_2/img_4.png', alt='Texto que describa la imagen')

              p(numero="3" titulo="&lt;head&gt;") El documento necesita una cabecera en donde se suministra información (en la parte superior del documento).
                img.img-a.mt-4(src='@/assets/curso/tema_2/img_5.png', alt='Texto que describa la imagen')

              .row(numero="4" titulo="&lt;body&gt;")
                .col-lg-12
                  p Esta etiqueta permite encapsular todo el contenido que se va a mostrar en el documento HTML.<br><br> Con estas etiquetas ya es posible construir el primer documento estructurado en HTML. A excepción de la primera etiqueta <strong>&lt;!DOCTYPE&gt;</strong>, todas tienen una etiqueta de apertura y otra de cierre.
                  .row.justify-content-center
                    .col-lg-6
                      img.img-a.mt-4(src='@/assets/curso/tema_2/img_6.png', alt='Texto que describa la imagen')
                    .col-lg-6
                      img.img-a.mt-4(src='@/assets/curso/tema_2/img_7.png', alt='Texto que describa la imagen')

              .row(numero="5" titulo="&lt;meta&gt;") 
                p Etiqueta que, junto con el atributo específico, permite modificar el comportamiento de lo que se va a mostrar en el documento, por ejemplo: atributo #[b charset=”iso-8859-1”] permite especificar la codificación de los caracteres y cómo se mostrará el texto al usuario, el atributo #[b name=”description” content=”Ejemplo de HTML5” y el name=”keywords” content=”HTML5, CSS3, Javascript”] define otros aspectos al momento de mostrar un documento Web, la forma correcta de escribir estas etiqueta y la forma de agregarla a la estructura es dentro del bloque &lt;head&gt; &lt;/head&gt; del documento y se utilizará de forma global para todos los documentos HTML enlazados al sitio o a la aplicación.

                img.img-a.mt-4(src='@/assets/curso/tema_2/img_8.svg', alt='Texto que describa la imagen')

              .row(numero="6" titulo="&lt;title&gt;") 
                p Esta etiqueta permite ponerle un título al documento; este título se mostrará en la pestaña del #[i browser] donde se despliega el documento HTML.

                img(src='@/assets/curso/tema_2/img_30.svg', alt='Texto que describa la imagen')

              .row(numero="7" titulo="&lt;link&gt;") 
    ...
    .cajon.color-primario.p-4.mb-4(data-aos="slide-right")
      p.mb-0 La estructura del cuerpo no es más que la estructura que se crea dentro del #[b #[i body]]; normalmente se le denomina #[b plantilla], y de esta forma es posible mostrar, organizadamente y por secciones, la información que llegará al usuario.
    ...
    .row.justify-content-center
      .col-lg-10(data-aos="flip-up")
        p.mb-5 A continuación, se muestran algunas estructuras del #[i #[strong body]] que normalmente se utilizan y se identifican, al momento de ingresar a un sitio #[i web] o a una aplicación #[i web]; se debe tener presente que estas estructuras pueden variar, según el diseñador #[i web], pero, normalmente, se siguen algunos estándares:

        SlyderC.mb-5(:datos="datosSlyder")(data-aos="flip-up")

    .row.z-i
      .col-lg-4.z-i.d-none.d-lg-block
        img.img-a(src='@/assets/curso/tema_2/img_19.png', alt='Texto que describa la imagen')

    .row.justify-content-center
      .col-lg-4
      .col-lg-8.p_top1(data-aos="slide-right").d-none.d-lg-block
        .row
          .col-lg-6
            hr.hr1.mt-0
    ...
    .row.justify-content-center.d-block.d-lg-none.mt-0
      .col-lg-4
        ...
        .col-lg-11
          .row.bg_7.py-4.px-0
            ...
            .col-lg-8
              .row.align-items-center(data-aos="slide-left")
                .col-lg-8
                  p.mb-4 Para afianzar su saber en lo relacionado con los elementos del contenido, estudie atentamente el #[b Anexo_1_ElementosDelContenido]. Recuerde llevar registro de los aspectos más destacados e importantes, en su libreta personal de apuntes.
                .col-lg-4.rig_ane
                  a.anexo.mb-4(:href="obtenerLink('/downloads/Elementos_del_contenido.pdf')" target="_blank")
                    .anexo__icono
                      img(src="@/assets/template/icono-pdf.svg")
      ...
      .py-4.py-md-5.bg_08(titulo="Video" :icono="require('@/assets/curso/tema_2/img_20.svg')")
        .row.p-5
          .col-md-12.mb-4.mb-md-0
            p.mb-5 Este elemento utiliza etiquetas de apertura y de cierre #[b &lt;video&gt;] y solo es obligatorio colocar la ruta de acceso al video #[b src]; utiliza, además, algunos atributos para el control del elemento como: #[i #[b width]] y #[i #[b heigth]], para el tamaño en el que se va a mostrar el video en el #[b #[i browser]].
            img.img-a(src='@/assets/curso/tema_2/img_25.png', alt='Texto que describa la imagen')

      .py-4.py-md-5.bg_08(titulo="Atributos de video" :icono="require('@/assets/curso/tema_2/img_21.svg')")
        .row.p-5
          .col-md-12.mb-4.mb-md-0
            p.mb-5 Algunos atributos adicionales de video son el #[b #[i autoplay]], utilizado para indicar al navegador que se reproducirá automáticamente. Así mismo, el #[b #[i loop]] que permite reproducir de nuevo el video cuando llegue al final. Con esta etiqueta y estos atributos es posible ubicar los videos dentro un sitio o aplicación #[i web].
            img.img-a(src='@/assets/curso/tema_2/img_26.png', alt='Texto que describa la imagen')
      .py-4.py-md-5.bg_08(titulo="Audio" :icono="require('@/assets/curso/tema_2/img_22.svg')")
        .row.p-5
          .col-md-12.mb-4.mb-md-0
    ...
    .bg_09.p-4
      p.text-center A continuación, se presenta un listado de etiquetas que son las que comúnmente se emplean para la construcción de sitios o interfaces web. 

    .row.justify-content-center
      .col-lg-10.z-i
        img.img-a.im_top(src='@/assets/curso/tema_2/img_29.svg', alt='Texto que describa la imagen')
    ...
    .row.justify-content-center
      .col-lg-10
        .bg_7.p-4.p_top3.mb-5
          .row.align-items-center.mt-5 
            ...
            .col-lg-4(data-aos="slide-right")
              a.anexo.mb-4.mt-4(:href="obtenerLink('/downloads/Anexo_2_RerefenciasYEtiquetas.pdf')" target="_blank")
                .anexo__icono
                  img(src="@/assets/template/icono-pdf.svg")
                .anexo__texto
                  h5.mb-0 Descargar
        ...
        .row.align-items-center
            ...
            .col-lg-4(data-aos="slide-right")
              a.anexo.mb-4.mt-4(href="https://developer.mozilla.org/es/docs/Web/HTML" target="_blank")
                .anexo__icono
...
<script>
import LineaTiempoDD from '../components/LineaTiempoDD'
export default {
  name: 'Tema2',
  components: {
    LineaTiempoDD,
  ...
  data: () => ({
    ...
    datosSlyder: [
      {
        texto:
          'Esta plantilla está dividida en secciones, en donde se suministrará información relevante para el usuario; la <strong>cabecera</strong> es, normalmente, utilizada para mostrar, entre otros, <i>banners</i> e imágenes corporativas de la empresa dueña del sitio <i>web</i>.',
        imagen: require('@/assets/curso/tema_2/img_13.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        texto:
          'Bajo la cabecera se encuentra la <b>barra de navegación</b>: allí se muestra, normalmente, el menú de navegación de todo el sitio <i>web</i> e información principal. Si se tiene una sección de noticias y está en el menú de navegación, me mostrarán, en la parte de información principal, las noticias que se hayan cargado al sitio <i>web</i>.',
        imagen: require('@/assets/curso/tema_2/img_14.png'),
        // leyendaImagen: 'Leyenda de la imagen',
      },
      {
        texto:
          'En la <b>barra lateral</b> pueden mostrarse <i>links</i> de interés para los usuarios o información del autor, entre otras cosas. Por último, se cuenta con la sección institucional, a la que se llamó de esta forma porque, normalmente, se utiliza para mostrar información de la empresa del autor; generalmente, estas plantillas son utilizadas para crear blogs.',
        imagen: require('@/assets/curso/tema_2/img_15.png'),
        //leyendaImagen: 'Leyenda de la imagen',
      },
      {
        texto:
          'Este es un ejemplo de una estructura y su escritura en código HTML.',
        imagen: require('@/assets/curso/tema_2/img_16.png'),
        //leyendaImagen: 'Leyenda de la imagen',
      },
      {
        texto:
          'HTML5 permite crear esta estructura básica, usando nuevos elementos para dividir la plantilla y mostrar la sección correspondiente. Al momento de crear la estructura de la plantilla dentro del <i><b>body</b></i>, como se muestra en la imagen, se utilizan etiquetas que permiten dividir y estructurar las secciones del sitio, página o aplicación <i>web</i>.',
        imagen: require('@/assets/curso/tema_2/img_17.svg'),
        //leyendaImagen: 'Leyenda de la imagen',
      },
      {
        texto:
